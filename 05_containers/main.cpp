...
int main(void)
{
    // Will man viele variablen gleichen Typs speichern, so verwendet man einen Container
    ...
    // Strings sind grundsätzlich nichts anderes als Arrays aus char's, also Zeichenfolgen.
